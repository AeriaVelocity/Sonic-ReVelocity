...
func _process(_delta):
    score.add_theme_constant_override("margin_left", edge_spacing * 2)
    time.add_theme_constant_override("margin_left", edge_spacing * 1)
    rings.add_theme_constant_override("margin_left", edge_spacing * 0)
